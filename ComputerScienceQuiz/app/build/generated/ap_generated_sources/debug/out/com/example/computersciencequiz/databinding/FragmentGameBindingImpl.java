...
import com.example.computersciencequiz.BR;
...
public class FragmentGameBindingImpl extends FragmentGameBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.questionImage, 6);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.game == variableId) {
            setGame((com.example.computersciencequiz.GameFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setGame(@Nullable com.example.computersciencequiz.GameFragment Game) {
        this.mGame = Game;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.example.computersciencequiz.GameFragment.Question gameCurrentQuestion = null;
        ...
        com.example.computersciencequiz.GameFragment game = mGame;
